...
def get_tp(actual, predicted, threshold):
    ...
    # print(f'> Predicted Classes in tp: {predicted_classes}')
    tp = 0
...
def get_fp(actual, predicted, threshold):
    predicted_classes = pred_to_classes(actual, predicted, threshold)
    # print(f'> Predicted Classes in fp: {predicted_classes}')
    fp = 0
    for i in range(len(predicted_classes)):
...
def precision(actual, predicted, threshold):
    print(f'Actual: {actual} | Predicted: {predicted} | Threshold: {threshold}')
    print(f'get_tp: {get_tp(actual, predicted, threshold)} | get_fp: {get_fp(actual, predicted, threshold)}')
