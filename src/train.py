...
from data_prepare import dataset, trainloader, testloader, LS_testloader, npy_file, npy_file, LS_npy_file, bs, es, ns, total, seen_prot, in_device, trainset, args
...
####### TEXT OUTPUT PHASE #######
if TempLogTF:
  OutLogFile = f'Dataset_TEMP_Log_cuda{in_device}.txt'
else:
  OutLogFile = f'Dataset_NOSEEN_LS_Investment_Log_cuda{in_device}.txt'

with open(OutLogFile, 'a') as file:
